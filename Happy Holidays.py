...
for x in x_position-x_seperation, x_position+x_seperation: 
    make_circle(snowman, x, y_positions[0] + y_offset, 15, "black") 
...
text.write("Happy Holidays to Arch", font=("Apple Chancery", 30, "bold"), align="center") 
text.setposition(130, 140) 
text.color("dark blue") 
text.write("Yale ", font=("Times New Roman", 30, "bold"), align="right") 
text.color("black") 
text.write("CORE", font=("Times New Roman", 30, "normal"), align="left") 
text.setx(50) 
